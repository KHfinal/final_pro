...
<header class="sticky-top">
        ...
        <div class="container">
            <div class="row">
                <div class="card col-sm-2">
                    <img class="card-img-top" src="${path }/resources/img/KakaoTalk_1.png">
                    <div class="card-img-overlay">
                        <p>카테고리</p>
                    </div>
                </div>
                <div class="card col-sm-2">
                    <img class="card-img-top" src="${path }/resources/img/KakaoTalk_2.png">
                    <div class="card-img-overlay">
                        <p>카테고리</p>
                    </div>
                </div>
                <div class="card col-sm-2">
                    <img class="card-img-top" src="${path }/resources/img/KakaoTalk_3.png">
                    <div class="card-img-overlay">
                        <p>카테고리</p>
                    </div>
                </div>
                <div class="card col-sm-2">
                    <img class="card-img-top" src="${path }/resources/img/KakaoTalk_4.png">
                    <div class="card-img-overlay">
                        <p>카테고리</p>
                    </div>
                </div>
                <div class="card col-sm-2">
                    <img class="card-img-top" src="${path }/resources/img/KakaoTalk_5.png">
                    <div class="card-img-overlay">
                        <p>카테고리</p>
                    </div>
                </div>
                <div class="card col-sm-2">
                    <img class="card-img-top" src="${path }/resources/img/KakaoTalk_6.png">
                    <div class="card-img-overlay">
                        <p>카테고리</p>
                    </div>
                </div>   
    ...
    <section class="row">
		...
		<div class="container mt-3" style="height: 3000px;">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6 portfolio-item">
							<a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
								...
								<img class="img-fluid" src="i${path }/resources/img/04-thumbnail.jpg" alt="">
							</a>
							<div class="portfolio-caption">
								<h4>Lines</h4>
